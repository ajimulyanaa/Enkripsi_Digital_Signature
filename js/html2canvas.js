...
(function (window, document, undefined) {
  ...
  _html2canvas.Parse = function (images, options) {
    ...
    function getTransform(element, parentStack) {
      ...
      var transformOrigin =
        getCSS(element, 'transform-origin') || getCSS(element, '-webkit-transform-origin') || getCSS(element, '-moz-transform-origin') || getCSS(element, '-ms-transform-origin') || getCSS(element, '-o-transform-origin') || '0px 0px';
